(function(h) {
    ...
    function rb(a) {
        var b = a.oClasses,
            ...
            e = a.oPreviousSearch,
            f = a.aanFeatures,
            g = '<input type="search" id="search" class="' + b.sFilterInput + ' form-control search"/>',
            j = d.sSearch,
            j = j.match(/_INPUT_/) ? j.replace("_INPUT_", g) : j + g,
            b = h("<div/>", {
                id: !f.f ? c + "_filter" : null,
                "class": b.sFilter
            }).append(h("<label for='search'  class='control-label'/>").append(j)),
            f = function() {
                var b = !this.value ?
                    "" : this.value;
                b != e.sSearch && (ga(a, {
    ...
    m.defaults = {
        ...
        oLanguage: {
            oAria: {
                sSortAscending: ": Ordenar colunas ascendentes",
                sSortDescending: ": Ordenar colunas descendentes"
            },
            oPaginate: {
                sFirst: "Primeira",
                sLast: "Última",
            ...
            sSearch: "<i class='glyphicon glyphicon-search inner-addon'></i>",
            sSearchPlaceholder: "",
            sUrl: "",
